+++
date = '2026-08-25T23:42:37+02:00'
draft = false
title = 'Genesis'
+++
...
I only use Gemini as a search engine, mostly for finding more easily techinical documentation details or niche articles, because Google really sucks at its job nowadays. Maybe I'll write my deepest opinions about AI later.
...
From this moment, I used computers weekly, sometimes unreasonably at a daily basis, playing games, crawling their data files from the File Explorer and feeling like Indiana Jones, wondering why I couldn't open a binary file without being prompt which program I wanted to use to open it; installing more games like Lego Racers or Rayman Raving Rabbids; opening Windows Movie Maker and loading some pictures taken with my [Logitech Quick Cam](https://upload.wikimedia.org/wikipedia/commons/2/2c/Logitech_QuickCam_Express_-8477.jpg), discovering unpurposely the stop motion technique using my Legos figurines...
...
- I did some tracks you can find on [Soundcloud](https://soundcloud.com/user-131837480-851531639).
- I prototyped some tiny video games on [itch.io](https://vegasword.itch.io/).
- I started to get a bit more "serious" with my [photos](https://vegasword.github.io/gallery/) as well.
- I felt again in love with video editing thanks to [Blick](https://blickeditor.com/) video editor that a friend of mine is working on. Here's a [video](https://www.youtube.com/watch?v=_J8nqCQQUA0) I did and here's another [one](https://www.youtube.com/watch?v=FQf4dpvPI2g).
...
I'll try to pick the next topic I want to write on.
